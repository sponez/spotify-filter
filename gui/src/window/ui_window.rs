...
impl UiWindow {
    ...
    pub fn set_hotkeys(&self, filter_hotkey: &str, pass_hotkey: &str) {
        self.window
            .set_filter_hotkey(slint::SharedString::from(filter_hotkey));
        self.window
            .set_pass_hotkey(slint::SharedString::from(pass_hotkey));
    }
            ...
            move || {
                while let Ok(response) = rx.try_recv() {
                    ...
                    match response {
                        ...
                        AppResponse::PlaylistsLoaded(result) => match result {
                            Ok(playlists) => {
